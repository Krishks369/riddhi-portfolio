...
})({"d6lmz":[function(require,module,exports) {
...
const scroll = ()=>{
    ...
    }).addLabel("start", 0).to(DOM.sections.columns, {
        ease: "none",
        startAt: {
            scale: 0.8
        },
...
parcelHelpers.export(exports, "getDistanceToCenter", ()=>getDistanceToCenter);
 ...
 */ const getTranslationDistance = (element1, spread = 400, maxDistance = 5000)=>{
    ...
    const elCenter = {
        x: rect.left + element1.offsetWidth / 2,
        y: rect.top + element1.offsetHeight / 2
    };
    const win = {
        x: winsize.width / 2,
        y: winsize.height / 2
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["d6lmz","30wP2"], "30wP2", "parcelRequiree63f")
